-- Commented out because it has nothing to do with COD and adds server network variables,
-- but feel free to uncomment.

-- Make sure to check out Zet0r's Banter Brigade steam group as this used to a reward for joining it.
