-- This Map Vote menu has been deprecated, see mapvote/  - Ethorbit
...
-- 		caller:ChatPrint("That config voting menu is disabled!")
--
...
--
	function nzInterfaces.ConfigLoader( data, vote, votetime )
		if vote then return end -- Exploit fixed by Ethorbit
...
-- 		--print(ply:Nick() .. " tried to exploit out of the config/map by using nz_rtv!")
