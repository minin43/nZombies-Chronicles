-- Changed default to 0 because it sucks ass and interferes with things.
if not ConVarExists("nz_papattachments") then CreateConVar("nz_papattachments", 0, {FCVAR_SERVER_CAN_EXECUTE, FCVAR_NOTIFY}, "Whether Pack-a-Punching a CW2.0 weapon will attach random attachments for each category. Will also strip players of attachments at the beginning of the game.") end
